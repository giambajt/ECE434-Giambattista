...
static unsigned int gpioLED1 = 60;       ///< hard coding the LED gpio for this example to P9_23 (GPIO60)
static unsigned int gpioLED2 = 50;	//P9_14
static unsigned int gpioButton1 = 47;   ///< hard coding the button gpio for this example to P8_15 (GPIO115)
static unsigned int gpioButton2 = 65;	//P8_18
...
// gpio_set_value(gpioLED, ledOn);          // Not required as set by line above (here for reference)
   ...
   printk(KERN_INFO "GPIO_TEST: The button is mapped to IRQ2: %d\n", irqNumber2);
