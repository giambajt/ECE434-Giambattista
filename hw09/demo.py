...
SAMPLE_SPREADSHEET_ID = '1C7wOIppDHjk3ljGD0_u7XJAAZhTLZMqoHc3Rm4P0qjI'
...
def main():
    ...
    values = [ [time.time()/60/60/24+ 25569 - 5/24, int(lines[0])/1000,int(lines2[0])/1000,int(lines3[0])/1000]]
    body = {'values': values}
